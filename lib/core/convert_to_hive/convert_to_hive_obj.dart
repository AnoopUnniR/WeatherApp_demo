...
//converts the json object model of the weather data to Hive adapter model 
//for the purpose of saving it locally
class ConvertToHiveObj {
  ForecastModelDbModel objToHiveobj(ForecastModel forecastmodel) {
